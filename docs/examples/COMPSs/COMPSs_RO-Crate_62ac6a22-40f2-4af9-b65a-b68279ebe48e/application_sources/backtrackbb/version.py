...
# scheme that setupagents uses.  If “git describe” returns an error
...
# NO IMPORTS FROM SOURCE_SPEC OR FUTURE IN THIS FILE! (file gets used at
# installation time)
import io
import os
import inspect
...
SOURCE_SPEC_ROOT = os.path.abspath(os.path.join(script_dir, os.pardir))
