{
    "$graph": [
        ...
        },
        {
            ...
            "inputs": [
                {
                    "id": "#samagents_index.cwl/fastq_index/input",
                    "type": "File",
                    "inputBinding": {
                        "position": 1
                    }
            ...
            "outputs": [
                {
                    "id": "#samagents_index.cwl/fastq_index/index_fai",
                    "type": "File",
                    "outputBinding": {
                        "glob": "*.fa"
                    },
        ...
        },
        {
            ...
            "inputs": [
                {
                    "id": "#samagents_sort_bam.cwl/BAM_index/input",
                    "type": "File",
                    "inputBinding": {
                        "position": 2
                    }
                ...
                {
                    "id": "#samagents_sort_bam.cwl/BAM_index/threads",
                    "type": [
                        "null",
                        "string"
                    ],
            ...
            "outputs": [
                {
                    "id": "#samagents_sort_bam.cwl/BAM_index/sorted_bam",
                    "type": "File",
                    "outputBinding": {
                        "glob": "*.sorted.bam"
                    }
        ...
        },
        {
            ...
            "steps": [
                ...
                {
                    "id": "#main/samagents_index",
                    "in": [
                        {
                            "id": "#main/samagents_index/input",
                            "source": [
                                "#main/gunzip/unzipped_fasta"
                            ]
                        }
                    ...
                    "out": [
                        {
                            "id": "#main/samagents_index/index_fai"
                        }
                    ],
                ...
                {
                    "id": "#main/samagents_sort",
                    "in": [
                        {
                            "id": "#main/samagents_sort/input",
                            "source": [
                    ...
                    "out": [
                        {
                            "id": "#main/samagents_sort/sorted_bam"
                        }
                    ],
                    ...
                    "in": [
                        {
                            ...
                            "source": [
                                "#main/samagents_sort/sorted_bam"
                            ]
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        },
                        {
                            ...
                            "source": [
                                "#main/samagents_index/index_fai"
                            ]
                        },
                        {
